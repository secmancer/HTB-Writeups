...
- Displays:
    ...
    - Graphs showing progress and activity.
...
- Filter by OS, difficulty, completion, or rating.
...
- Each lab has a distinct scenario and difficulty:    
    - **Dante:** Beginner-friendly introduction to pentesting.
    - **Offshore:** Active Directory corporate network.
    - **Cybernetics:** Hardened AD for experienced testers.
    - **RastaLabs:** Red team simulation.        
...
- Modes:
    ...
    - **Server Siege:** Pure attack race.
- Match limits: Free = 2/month, VIP = 5, VIP+ = 10.    
...
- Start with:
    ...
    - **Easy Machines (Lame, Blue, Nibbles, Shocker, Jerry)**
    - **Beginner Challenges (Weak RSA, Easy Pass)**
- Progress to: Endgames → Pro Labs → Battlegrounds for competitive and real-world readiness.